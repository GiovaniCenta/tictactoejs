...
function playFunction(player1,player2){ //who's going to play and draw X or O in the boxes
    let p1w=0;
    let p2w=0;
    let counterFail=0;   
    ...
    //while(p1w<3 && p2w<3){
        ...
        boxes[i].addEventListener("click",function(){
            ...
            if (this.childNodes.length==0){ //if this box isnt occupied
                ...
                if ( win == 1){
                    p1w=p1w+1;
                    console.log("player 1 wins: " + p1w);}
                else if (win == 2 ){
                    p2w=p2w+1;
                    console.log("player 2 wins: " + p2w);}
                 counterFail++;
